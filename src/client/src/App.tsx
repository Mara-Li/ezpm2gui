        ...
        <div className="flex">
          ...
          <nav className="fixed w-full z-50 h-9 flex items-center border-b bg-[#0a0a0a] border-[#1e1e1e]">
            <div className="flex items-center w-full px-3 gap-2">
              ...
              <Link
                to="/"
                className="flex items-center gap-1.5 text-xs font-bold text-[#e8e8e8] tracking-tight no-underline shrink-0"
              >
                <img
                  src="/logo192.svg"
                  alt=""
                ...
                />
                <span className="whitespace-nowrap">EZ PM2 GUI</span>
              </Link>
              ...
              <div className="flex items-center gap-1.5">
                ...
                {/* @group GitHub : Star + repo link — hidden on mobile to keep the nav bar from overflowing */}
                ...
                {/* Divider */}
                <span className="hidden sm:block h-4 w-px mx-0.5 bg-[#1e1e1e]" />
                ...
                {/* @group WhatsNew/About : Hidden on mobile to keep the nav bar from overflowing */}
                <div className="hidden sm:flex items-center gap-1.5">
                  {/* What's New */}
                  <button
