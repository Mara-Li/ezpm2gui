  ...
  return (
    <div ref={ref} className="relative">
      ...
      <button
        onClick={() => setOpen(o => !o)}
        title={current.label}
        className="flex items-center gap-1 p-1 rounded-sm transition-colors text-[12px] text-[#555] hover:text-[#888]"
      >
        ...
        <div className="absolute right-0 top-full mt-1 w-32 bg-[#111] border border-[#1e1e1e] rounded-sm z-[200] overflow-hidden">
          {LANGUAGES.map(lang => (
            <button
              ...
              className={`w-full text-left px-3 py-1.5 text-[12px] transition-colors hover:bg-[#1a1a1a]
