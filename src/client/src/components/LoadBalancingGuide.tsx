  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center justify-between">
        <div>
          <p className="text-[11px] font-mono uppercase tracking-[0.2em] text-[#555] mb-1">pm2 / docs</p>
          <h1 className="text-sm font-mono font-bold text-[#e8e8e8]">▸ LOAD BALANCING GUIDE</h1>
          <p className="text-[12px] font-mono text-[#555] mt-0.5">{t('loadBalancing.subtitle')}</p>
        </div>
        <button
      ...
      <div className="bg-[#111] border border-[#1e1e1e] rounded-sm overflow-hidden">
        ...
        >
          <span className="text-[13px] font-mono font-bold text-[#e8e8e8] uppercase tracking-[0.05em]">
        ...
        {expanded === 'panel1' && (
          <div className="px-4 pb-4 border-t border-[#1e1e1e]">
            <p className="text-[12px] font-mono text-[#888] leading-relaxed mt-3 mb-3">
            ...
            <ul className="space-y-1.5">
              {[
                ...
                <li key={text} className="flex items-start gap-2">
                  <span className={`text-[11px] font-mono mt-0.5 ${color}`}>{symbol}</span>
                  <span className="text-[12px] font-mono text-[#888] leading-relaxed">{text}</span>
                </li>
              ))}
            </ul>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {[
                ...
                <div key={title} className="bg-[#141414] border border-[#1e1e1e] rounded-sm p-3">
                  <p className="text-[13px] font-mono font-bold text-[#e8e8e8] uppercase tracking-[0.05em] mb-1">{title}</p>
                  <p className="text-[12px] font-mono text-[#888] leading-relaxed mb-2">{desc}</p>
        ...
        {expanded === 'panel3' && (
          <div className="px-4 pb-4 border-t border-[#1e1e1e]">
            <ul className="space-y-3 mt-3">
              {[
                ...
                <li key={primary} className="flex items-start gap-3">
                  <span className="text-[11px] font-mono text-[#f59e0b] mt-0.5">▸</span>
                  <div>
                    <p className="text-[12px] font-mono font-bold text-[#e8e8e8]">{primary}</p>
                    <p className="text-[12px] font-mono text-[#888] leading-relaxed">{secondary}</p>
                  </div>
                </li>
              ))}
            </ul>
            ...
            <div className="bg-[#1a0e00] border border-[#f59e0b]/20 rounded-sm p-3 mt-4">
              <p className="text-[12px] font-mono text-[#f59e0b] leading-relaxed">
